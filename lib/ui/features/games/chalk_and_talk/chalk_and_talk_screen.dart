...
class _ChalkAndTalkScreenState extends ConsumerState<ChalkAndTalkScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return GameScaffold(
      title: L10nGameHelpers.getGameTitle(context, 'chalk_and_talk'),
      subtitle: L10nGameHelpers.getGameSubtitle(context, 'chalk_and_talk'),
      actions: [
        IconButton(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(AppLocalizations.of(context)!.btnSubmit, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                ),
              ),
            ],
          ),
