...
class _InequalityBalanceOpsScreenState extends ConsumerState<InequalityBalanceOpsScreen> {
  ...
  void _onAnswer(String symbol) {
    ...
    if (symbol == _correctSymbol) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(l10n.snackbarIncorrectInequality(_leftExpr, _leftVal, _correctSymbol, _rightExpr, _rightVal)),
  ...
  Widget build(BuildContext context) {
    ...
    return GameScaffold(
      title: L10nGameHelpers.getGameTitle(context, 'inequality_balance_ops'),
      subtitle: L10nGameHelpers.getGameSubtitle(context, 'inequality_balance_ops'),
      actions: [
        IconButton(
